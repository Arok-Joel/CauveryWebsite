...
export default function EmployeeProfile() {
  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        { label: "Guardian Name", value: profile.employee.guardianName },
      ],
    },
    {
      title: "Employee Details",
      fields: [
        { label: "Date of Birth", value: new Date(profile.employee.dateOfBirth).toLocaleDateString() },
        ...
        { label: "Date of Joining", value: new Date(profile.employee.dateOfJoining).toLocaleDateString() },
