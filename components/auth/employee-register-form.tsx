...
const employeeRegisterFormSchema = z.object({
  ...
  pancardNumber: z.string().regex(/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/, "Please enter a valid PAN card number"),
  aadharCardNumber: z.string().regex(/^\d{12}$/, "Please enter a valid 12-digit Aadhar card number"),
